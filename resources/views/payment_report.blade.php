    ...
    <table>
        <THEAD>
            <tr>
                ...
                <th style="width: 10%">Subscription Fee
        ...
        <TBODY>
            ...
            @foreach ($users as $employee)
                <tr>
                    ...
                    </td> <td>{{ $employee->subDistrict->district->e_name }}</td>
                    </td> <td>{{ $employee->subDistrict->e_name }}</td>
                    ...
                    <td>
                        @if ($employee->payments->isNotEmpty())
                            {{ $employee->payments->first()->amount }}
                        @endif
                    </td>
                     <td style="color: {{ $employee->payments->isNotEmpty() ? 'green' : 'red' }}">
                        {{ $employee->payments->isNotEmpty() ? 'Paid' : 'Unpaid' }}
                    </td>
